    ...
    <div className="min-h-screen bg-zinc-50 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-2xl mb-8 border border-white/20">
              ...
              <span className="text-sm font-black uppercase tracking-widest">Global Sustainability Platform</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden group hover:scale-[1.02] transition-transform">
            <CardHeader className="pb-2 bg-zinc-50/50">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Cities Analyzed</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              ...
              <p className="text-xs font-bold text-zinc-500 mt-4">Verified records in database</p>
            </CardContent>
          </Card>

          <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden group hover:scale-[1.02] transition-transform">
            <CardHeader className="pb-2 bg-zinc-50/50">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Average Score</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <div className="flex items-baseline gap-3">
              ...
              <p className="text-xs font-bold text-zinc-500 mt-4">Global sustainability rating</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden group hover:scale-[1.02] transition-transform">
            ...
            <CardContent className="pt-4">
              ...
              <p className="text-xs font-bold text-zinc-500 mt-4">Leading in sustainability</p>
            </CardContent>
          </Card>

          <Card className="shadow-2xl border-0 rounded-3xl overflow-hidden group hover:scale-[1.02] transition-transform">
            <CardHeader className="pb-2 bg-zinc-50/50">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Top Performer</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              {globalStats.topCity ? (
                <>
                ...
                <div className="text-zinc-400 font-bold py-2 italic">N/A</div>
              )}
            </CardContent>
          </Card>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <h2 className="text-4xl font-black text-zinc-900 tracking-tight">Top Sustainable Cities</h2>
            <p className="text-zinc-500 mt-3 text-xl font-medium">Leading the way in environmental responsibility</p>
          </div>
        ...
        {loading ? (
          ...
          <Card className="border-0 shadow-lg p-20 text-center rounded-[3rem]">
            ...
            <h3 className="text-3xl font-black text-zinc-900 mb-4">No City Data Available</h3>
            <p className="text-zinc-500 text-lg mb-10 max-w-md mx-auto">Be the first to contribute to the global index by assessing a city's sustainability.</p>
          ...
          <Card className="border-0 shadow-2xl p-12 rounded-[3.5rem] bg-zinc-900 text-white relative overflow-hidden">
            ...
            <CardHeader className="p-0 mb-12 relative z-10">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.4em] text-green-500">Global Insights</span>
              </div>
