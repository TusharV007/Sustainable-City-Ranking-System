    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-0 shadow-2xl overflow-hidden rounded-3xl">
        <div className="bg-green-600 p-8 text-white text-center">
          ...
          <h1 className="text-3xl font-black">Join Us</h1>
          <p className="text-green-100 font-medium">Start ranking sustainable cities today</p>
        </div>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-4 font-black text-zinc-400 tracking-widest">Or sign up with email</span>
              </div>
            </div>
          </div>
